...
$(".spaces__carousel-hide-menu").on("click", function (e) {
  e.preventDefault();
  $(this)
    .children(".spaces__carousel-text")
    .toggle("400", function () {});
});
...
$(".answers-arrow").on("click", function () {
  ...
  $(this)
    .children(".answers-arrow-svg")
    .children("path")
    .toggleClass("answers-arrow-toggle-path");
  $(this).toggleClass("answers-arrow-toggle-bg");
  $(this)
    .next(".answers-text-hidden")
    .toggleClass("answers-text-hidden-bg-toggle");
...
$("#home").on("click", function (e) {
  ...
  $("html, body").animate(
    { scrollTop: $(".spaces").offset().top - headerHeight },
    500
  );
  document.getElementById("checkbox").checked = false;
});
$("#workspace").on("click", function (e) {
  ...
  let headerHeight = $(".header").height();
  $("html, body").animate(
    { scrollTop: $(".workspace").offset().top - headerHeight },
    500
  );
  document.getElementById("checkbox").checked = false;
});
$("#service").on("click", function (e) {
  ...
  let headerHeight = $(".header").height();
  $("html, body").animate(
    { scrollTop: $(".answers").offset().top - headerHeight },
    500
  );
  document.getElementById("checkbox").checked = false;
});
$("#reviews").on("click", function (e) {
  ...
  let headerHeight = $(".header").height();
  $("html, body").animate(
    { scrollTop: $(".space-gallery").offset().top - headerHeight },
    500
  );
  document.getElementById("checkbox").checked = false;
});
$("#events").on("click", function (e) {
  ...
  let headerHeight = $(".header").height();
  $("html, body").animate(
    { scrollTop: $(".facilities").offset().top - headerHeight },
    500
  );
  document.getElementById("checkbox").checked = false;
});
